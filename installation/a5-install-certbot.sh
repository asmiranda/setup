...
# certbot certonly --manual --preferred-challenges=dns --email aiamemiranda@gmail.com --server https://acme-v02.api.letsencrypt.org/directory --agree-tos -d *.dynamikosoft.com -d www.*.dynamikosoft.com
